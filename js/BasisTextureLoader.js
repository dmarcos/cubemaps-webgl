 ...
 * to the main thread.
 */
var BasisTextureLoader = THREE.BasisTextureLoader = function ( manager ) {
...
BasisTextureLoader.prototype = Object.assign( Object.create( THREE.Loader.prototype ), {
  ...
  detectSupport: function ( gl ) {

    var config = this.workerConfig;
    config.astcSupported = !!gl.getExtension( 'WEBGL_compressed_texture_astc' );
    config.bptcSupported = !!gl.getExtension( 'EXT_texture_compression_bptc' );
